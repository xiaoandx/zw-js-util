 ...
 * @version V1.0.0
*/
export const call = (fn: Function, obj: any | object, ...args: any): any => {
 ...
 * @version V1.0.0
*/
export const apply = (fn: Function, obj: any | object, args: any): any => {
  if(obj === undefined || obj === null)
    obj = {}
  obj.tempFunction = fn
  const result = obj.tempFunction(...args)
 ...
 * @version V1.0.0
*/
export const bind = (fn: Function, obj: any | object, ...args: any): any => {
  return (... argsz) => {
